...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setGoogleButtonText(mGoogleButton, "Continue with Google");

        //------------------------------------END OF FIREBASE EMAIL & PASSWORD AND GOODLE AUTHS----------
    ...
    private void setGoogleButtonText(SignInButton newButton, String buttonText){

        for (int i = 0; i < newButton.getChildCount(); i++){

            View v = newButton.getChildAt(i);
